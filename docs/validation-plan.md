...
**14-day pilot, then A$39/month including GST.** Five active sites, unlimited reports, no automatic conversion and no lock-in.

This is a pricing hypothesis, not a market benchmark. Do not discount it before hearing the objection in the customer’s own words.
...
6. Ask whether they will pay to repeat the workflow for the next visit.

Do not claim secure hosting, automatic PDF generation, client-link controls, offline operation or retention behaviour until the corresponding product slice exists and has been verified.
...
- Which clients actually expect a report? Which do not?
...
## Proposed green-light rule

Continue into product development only after at least **three businesses pay** and repeatedly use the core report workflow within **30 days**. This is an internal discipline threshold, not an industry benchmark.

Track:

- application → qualified conversation
- conversation → paid pilot
- first real report completed
- second report completed
- reports per active site
- support minutes per business
- photo-storage cost per report
- cancellation reason
...
- Generic form-builder functionality
- AI-generated report claims or automatic compliance assessment
- Accounting, CRM and property-management integrations
- App-store publication
- Paid acquisition

The purpose of the landing page is to test a narrow reporting job before broadening the software.
